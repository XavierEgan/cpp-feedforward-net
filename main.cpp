...
int main() {
    std::vector<size_t> layer_sizes = {16, 256, 16};
    ...
    Eigen::MatrixXf input = (Eigen::MatrixXf::Random(16, 16) + Eigen::MatrixXf::Constant(16, 16, 1.0f)) / 2.0f;
    Eigen::MatrixXf target = (Eigen::MatrixXf::Random(16, 16) + Eigen::MatrixXf::Constant(16, 16, 1.0f)) / 2.0f;
